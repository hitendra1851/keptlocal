...
export const tools: Tool[] = [
  ...
  // --- Image: HEIC to JPG ---
  {
    ...
    name: "HEIC to JPG",
    shortName: "HEIC → JPG",
    pageTitle: "HEIC to JPG — Convert iPhone Photos Free",
    description: "Convert iPhone HEIC photos to JPG instantly — no upload, no signup.",
    longDescription: "Convert HEIC to JPG without uploading — no signup, no account, no watermark. iPhone and iPad photos open everywhere once converted. Multiple files supported, ZIP download included. Files never leave your device.",
    category: "Image",
    icon: "M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z M15 13a3 3 0 11-6 0 3 3 0 016 0z",
    status: "live",
    keywords: ["heic to jpg", "convert heic to jpg", "heic to jpeg online free", "iphone photo to jpg", "convert heic without uploading", "heic to jpg no upload", "heic converter browser"],
    faq: [
      { q: "Are my photos uploaded to a server?", a: "No. Conversion uses the heic2any library running entirely in your browser. Your photos never leave your device — open DevTools → Network while converting to confirm zero upload requests." },
      { q: "Why are my iPhone photos in HEIC format?", a: "Apple switched iPhones to HEIC (High Efficiency Image Container) by default from iOS 11 (2017) to save storage space. HEIC compresses photos to roughly half the size of JPEG at the same quality. The downside is that most non-Apple software cannot open HEIC files." },
      { q: "Can I convert multiple HEIC files at once?", a: "Yes — select or drop multiple files. Each converts individually with its own download link. A Download ZIP button appears when all conversions finish so you can grab everything in one click." },
      { q: "Will the photo quality change?", a: "At 85% quality (Balanced), converted JPGs are visually indistinguishable from the originals. The file will be larger than the HEIC source because JPG is less efficient at compression — this is expected." },
      { q: "Are Live Photo or Portrait Mode depth maps preserved?", a: "No. The tool converts the primary image only. Portrait Mode depth maps and Live Photo video frames are not extracted — those require Apple's own tools to process." },
      { q: "Does this preserve EXIF metadata (date, location)?", a: "EXIF preservation depends on the heic2any library's decoding. Location and camera data may not be fully transferred to the output JPG. For EXIF-critical workflows, use a desktop tool like ImageMagick." },
    ],
  },
  // --- Image: PNG to JPG ---
  {
    ...
    name: "PNG to JPG",
    shortName: "PNG → JPG",
    pageTitle: "PNG to JPG — Free, No Upload",
    description: "Convert PNG images to JPG — batch supported, runs entirely in your browser.",
    longDescription: "Convert PNG to JPG without uploading — no signup, no account, no watermark. Choose quality, batch convert, download instantly. Transparent areas become white. Files never leave your device.",
    category: "Image",
    icon: "M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z",
    status: "live",
    keywords: ["png to jpg", "convert png to jpg", "png to jpeg online free", "png to jpg without uploading", "batch png to jpg converter", "png to jpg no signup"],
    faq: [
      { q: "Are my files uploaded to a server?", a: "No. Conversion uses the Canvas API entirely in your browser. Your images never leave your device." },
      { q: "What happens to transparent areas?", a: "JPG does not support transparency. Any transparent pixels in the source PNG become white in the JPG output. This is the standard approach — it prevents artefacts at transparent regions." },
      { q: "Can I convert multiple PNG files at once?", a: "Yes — drop or select multiple PNG files. Each converts individually. A ZIP download button appears when more than one file is converted." },
      { q: "Will PNG to JPG reduce the file size?", a: "Usually yes — significantly for photographs and complex images. PNG is lossless; JPG uses lossy compression. A photo PNG might be 5 MB; the equivalent JPG at 85% quality might be 400–600 KB with no visible quality difference." },
      { q: "Should I use High or Balanced quality?", a: "Balanced (85%) is indistinguishable from the original for most photos at normal viewing sizes. Use High (95%) for images with fine detail you plan to print or enlarge." },
      { q: "Can I convert PNG files with transparency without getting a white background?", a: "Not with JPG output — JPG does not support transparency. To preserve transparency, use PNG output instead. The Convert Image tool handles PNG-to-WebP conversion, which also supports transparency." },
    ],
  },
  // --- Image: WebP to JPG ---
  {
    ...
    name: "WebP to JPG",
    shortName: "WebP → JPG",
    pageTitle: "WebP to JPG — Free Converter, No Upload",
    description: "Convert WebP images to JPG for universal compatibility — entirely in your browser.",
    longDescription: "Convert WebP to JPG without uploading — no signup, no account, no watermark. Batch convert, choose quality, download instantly. Files never leave your device.",
    category: "Image",
    icon: "M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z",
    status: "live",
    keywords: ["webp to jpg", "convert webp to jpg", "webp to jpeg online free", "webp to jpg no upload", "convert webp images browser", "webp converter free"],
    faq: [
      { q: "Are my files uploaded to a server?", a: "No. Your browser decodes WebP natively and the Canvas API handles re-encoding to JPG. Your files never leave your device." },
      { q: "Why do I need to convert WebP to JPG?", a: "WebP is well-supported in browsers but not universally supported by desktop software, email clients, and older applications. JPG is universally compatible — every piece of software that handles images supports JPG." },
      { q: "Can I convert multiple WebP files at once?", a: "Yes — drop or select multiple WebP files. A ZIP download button appears when more than one file is converted." },
      { q: "What happens to animated WebP files?", a: "Only the first frame is converted. The tool does not support animated WebP — it exports a single static JPG." },
      { q: "Will the output JPG be larger than the source WebP?", a: "Yes, usually. WebP is a more efficient format than JPEG for most images. Converting to JPG trades compression efficiency for compatibility — the file will be larger. This is expected and correct." },
      { q: "What about WebP images with transparency?", a: "Transparent areas become white in the JPG output. JPG does not support transparency. To preserve transparency, convert to PNG instead using the Convert Image tool." },
    ],
  },
  // --- Image: JPG to PNG ---
  {
    ...
    name: "JPG to PNG",
    shortName: "JPG → PNG",
    pageTitle: "JPG to PNG — Free, No Upload",
    description: "Convert JPG images to lossless PNG — batch supported, runs entirely in your browser.",
    longDescription: "Convert JPG to PNG without uploading — no signup, no account, no watermark. PNG output is lossless, preventing further quality loss on re-save. Batch convert multiple files. Files never leave your device.",
    category: "Image",
    icon: "M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z",
    status: "live",
    keywords: ["jpg to png", "convert jpg to png", "jpeg to png online free", "jpg to png without uploading", "batch jpg to png converter", "convert jpeg to png browser"],
    faq: [
      { q: "Are my files uploaded to a server?", a: "No. Conversion uses the Canvas API entirely in your browser. Your images never leave your device." },
      { q: "Why is the PNG larger than the original JPG?", a: "PNG is lossless — it stores every pixel without compression artefacts, which requires more space than JPEG's lossy compression. A 300 KB JPG might become a 2–3 MB PNG. This is expected and correct." },
      { q: "Does converting JPG to PNG improve the image quality?", a: "No. JPEG compression artefacts that exist in the source file are preserved in the PNG output — they cannot be undone. What PNG gives you is that no further quality is lost on subsequent saves." },
      { q: "Can I convert multiple JPG files at once?", a: "Yes — drop or select multiple files. Each converts individually. A ZIP download button appears when more than one file is converted." },
      { q: "Will the PNG have a transparent background?", a: "No. JPG does not contain transparency information. The output PNG has the same solid background as the source JPG. Creating transparent cutouts requires a separate masking step in an image editor." },
      { q: "When should I convert JPG to PNG?", a: "When you need to edit the image multiple times without quality loss, when you need to use the image as a layer in a composition, or when you need the image in a format that supports transparency for subsequent editing." },
    ],
  },
  // --- PDF: Flatten ---
  {
    ...
    pageTitle: "Flatten PDF — Lock Form Fields, No Upload",
    description: "Bake form fields and annotations into static page content — entirely in your browser.",
    longDescription: "Flatten a PDF without uploading — no signup, no account, no watermark. Locks form fields by converting them to static page content. Prevents editing of completed forms. Runs entirely in your browser.",
    category: "PDF",
    icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4",
    status: "live",
    keywords: ["flatten pdf", "flatten pdf form fields", "lock pdf form", "flatten pdf online free", "flatten pdf without uploading", "pdf flatten browser", "lock form fields pdf"],
    faq: [
      { q: "Are my files uploaded to a server?", a: "No. Flattening runs entirely in your browser using pdf-lib. Your PDF never leaves your device — open DevTools → Network while processing to confirm zero upload requests." },
      { q: "What is PDF flattening?", a: "Flattening merges the interactive form layer (text fields, checkboxes, radio buttons) with the static page content. Each field's current value is drawn permanently onto the page, and the interactive field is removed. The result looks identical but cannot be edited as a form." },
      { q: "Can I un-flatten a PDF?", a: "No. Flattening is irreversible — the interactive fields are removed from the PDF structure. Always keep a copy of the original fillable PDF if you might need to change values later." },
      { q: "Will empty form fields appear as blank spaces?", a: "Yes. An empty field's appearance (a blank area) is rendered as part of the page content. If a field was never filled in, a blank space appears where it was." },
      { q: "Does flattening affect password-protected PDFs?", a: "Encrypted PDFs cannot be flattened directly. Unlock the PDF first using the Unlock PDF tool, then flatten it." },
      { q: "Will digital signatures be affected?", a: "Cryptographic digital signatures may be invalidated by flattening because the document structure changes. If the PDF has a PAdES or PKCS#7 digital signature, the signature's integrity check will fail after flattening. Visual signature images are unaffected." },
    ],
  },
  // --- PDF: Add Image ---
  {
    ...
    pageTitle: "Add Image to PDF — Free, No Upload",
    description: "Insert a JPG or PNG image onto any PDF page — entirely in your browser.",
    longDescription: "Add an image to a PDF without uploading — no signup, no account, no watermark. Choose position, size, and which pages to stamp. JPG and PNG supported. Files never leave your device.",
    category: "PDF",
    ...
    status: "live",
    keywords: ["add image to pdf", "insert image into pdf", "add photo to pdf free", "insert image pdf browser", "add image to pdf without uploading", "embed image pdf online free"],
    faq: [
      { q: "Are my files uploaded to a server?", a: "No. Your PDF and your image are processed entirely in your browser using pdf-lib. Nothing leaves your device — open DevTools → Network to confirm zero upload requests." },
      { q: "Which image formats are supported?", a: "JPG and PNG. For other formats (WebP, HEIC, SVG), convert to JPG or PNG first using the Convert Image or SVG to PNG tools." },
      { q: "Can I add an image to every page?", a: "Yes — choose 'All pages' in the Page dropdown. The image is inserted at the same position on every page, which is useful for adding logos, watermarks, or stamps consistently throughout a document." },
      { q: "What size should I set the image width to?", a: "PDF dimensions are in points (72 points = 1 inch). A standard A4 page is 595 points wide. For a logo taking about 5cm: set width to around 140pt. For a half-page-width image: around 250pt." },
      { q: "Will the image cover existing content?", a: "Yes — the image is placed on top of the page. If it overlaps existing text or graphics, it will cover them. Adjust the size or margin to avoid this, or choose a position that lands in a whitespace area of the page." },
