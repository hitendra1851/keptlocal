...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    longDescription: "Convert PDF pages to crisp JPG images — no upload, no signup, no account needed. Choose a quality preset and every page renders locally. Single pages download as one file; multiple pages as a ZIP.",
    category: "PDF",
  ...
  },
  {
    ...
    longDescription: "Resize images to specific pixel dimensions, a percentage, or by longest side — free in your browser, no upload. Aspect ratio lock keeps proportions correct. Downloads instantly.",
    category: "Image",
